...
public class EFDataContext : DbContext, IDataContext {
    ...
    public IList<Product?> SelectProducts() => throw new NotImplementedException();
    public int InsertProduct(Product product) => throw new NotImplementedException();
    public int UpdateProduct(Product product) => throw new NotImplementedException();
    public int DeleteProduct(int id) => throw new NotImplementedException();
